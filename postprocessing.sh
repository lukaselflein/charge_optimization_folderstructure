...
module load smamp
module load gromacs
python ../bin/fitESPconstrained.py horton_charges/costfunction_average.h5 500_ps_snapshot/0_initial_structure/snapshot.pdb 500_ps_snapshot/0_initial_structure/example.top ../fitting_constraint_files/atoms_in_charge_group.csv ../fitting_constraint_files/charge_group_total_charge.csv ../fitting_constraint_files/atoms_of_same_charge.csv updated_charges.top horton_charges/fitted_point_charges.csv --qtot 0 --verbose 2>&1 >horton_charges/charge_fitting.log
